def merged_mass(mass1,mass2,spin1,spin2):
...
def merged_spin(mass1,mass2,spin1,spin2,bin_ang_mom):
...
# where q=m_2/m_1 and nu=q/((1+q)^2)
    ...
    merged_spin=0.686*((5.04*nu)-(4.16*nusq))+(0.4*((spin1/spin1_factor)+(spin2/spin2_factor)))
    return merged_spin
