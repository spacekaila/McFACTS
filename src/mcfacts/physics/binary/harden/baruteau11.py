...
def bin_harden_baruteau(disk_bins_bhbh, bin_properties_num, smbh_mass, timestep_duration_yr, norm_tgw, bin_num, time_passed):
    ...
    for j in range(0, bin_num):
        if disk_bins_bhbh[11,j] < 0:
            ...
            for i in range(0, bin_properties_num):
            ...
            if temp_bin_t_gw > timestep_duration_yr:
                ...
                disk_bins_bhbh[12,j] = time_passed
